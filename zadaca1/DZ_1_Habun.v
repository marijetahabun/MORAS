...
Proof.
  intros H. simpl.
  assert(A: forall l1 l2 : list B, NotL(AndL(NotL l1)(NotL l2))=OrL l1 l2).
  { induction l1, l2; simpl; try reflexivity.
    assert (B: Not(And(Not a)(Not b))=Or a b).
    { induction a, b; simpl; reflexivity. }
    rewrite B. rewrite IHl1. reflexivity. }
